...
<!--  	<div id="block1" class="block" draggable="true" ondragstart="dragstart_handler(this);" ondragover="return false;" ondrop="event.preventDefault();"> -->
	    ...
	    <div class="add add-down" onclick="addDown(this);">+
	   	</div>
 ...
 <script>
	...
	function addUp(obj){
 		...
 		if(divNum!=""){
	 		...
	 		$("<div class='block' "+"id='block"+$(".block").length+"'></div>").insertBefore(temp);
	 		
	 		/* 템플릿 본문 */
	 		
	 		temp.prev().prepend("<div class='add add-up' onclick='addUp(this);'>+</div>");
	 		temp.prev().append("<div class='add add-down' onclick='addDown(this);'>+</div>");
	 		temp.prev().append("<div class='default-btn option-btn' title='옵션' onclick='optionClick(this);'></div>");
	 		temp.prev().append("<div class='default-btn move-btn' title='이동' onclick='moveClick(this);'></div>");
	 		temp.prev().append("<div class='default-btn copy-btn' title='복사' onclick='copyClick(this);'></div>");
	 		temp.prev().append("<div class='default-btn del-btn' title='삭제' onclick='delClick(this);'></div>");
	...
	function addDown(obj){
 		...
 		if(divNum!=""){
	 		$("<div class='block'></div>").insertAfter(temp);
	 		
	 		/* 템플릿 본문 */
	 		
	 		temp.next().prepend("<div class='add add-up' onclick='addUp(this);'>+</div>");
	 		temp.next().append("<div class='add add-down' onclick='addDown(this);'>+</div>");
...
/* 		var img = new Image(); 
	...
	function drop_handler(obj) {
		...
		console.log(data);
		if(event.target.id=="mainCore" && !$(event.target).hasClass("block")) {
